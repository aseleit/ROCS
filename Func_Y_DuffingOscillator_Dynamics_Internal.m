...
function const = Func_Y_DuffingOscillator_Dynamics_Internal(X_in,U,p,t,data)
global ADiGator_Func_Y_DuffingOscillator_Dynamics_Internal
if isempty(ADiGator_Func_Y_DuffingOscillator_Dynamics_Internal); ADiGator_LoadData(); end
Gator1Data = ADiGator_Func_Y_DuffingOscillator_Dynamics_Internal.Func_Y_DuffingOscillator_Dynamics_Internal.Gator1Data;
...
cada1f8dY = 3.*cada1f1(:).^(3-1).*cada1f1dY;
cada1f8 = cada1f1.^3;
cada1f9dY = vdat.beta.*cada1f8dY;
cada1f9 = vdat.beta*cada1f8;
cada1td1 = cada1f7dY;
cada1td1 = cada1td1 + -cada1f9dY;
cada1f10dY = cada1td1;
cada1f10 = cada1f7 - cada1f9;
cada1td1 = zeros(118,1);
cada1td1(Gator1Data.Index11) = cada1f10dY;
cada1td1(Gator1Data.Index12) = cada1td1(Gator1Data.Index12) + cada1f3dY;
cada1f11dY = cada1td1;
cada1f11 = cada1f10 + cada1f3;
cada1td1 = zeros(177,1);
cada1td1(Gator1Data.Index13) = cada1f11dY;
cada1td1(Gator1Data.Index14) = cada1f4dY(Gator1Data.Index15);
dynF.dY = cada1td1;
dynF.f = cada1f4;
dynF.f(:,2) = cada1f11;
...
cada1td1 = sparse(Gator1Data.Index17,Gator1Data.Index18,X_vect.dY,118,118);
cada1td1 = data.map.A*cada1td1;
cada1td1 = cada1td1(:);
cada1f3dY = full(cada1td1(Gator1Data.Index19));
...
cada1td1 = zeros(413,1);
cada1td1(Gator1Data.Index23) = cada1tf1(:).*cada1tempdY;
cada1td1(Gator1Data.Index24) = cada1td1(Gator1Data.Index24) + delta_t.f.*cada1f4dY;
cada1f5dY = cada1td1;
cada1f5 = delta_t.f*cada1f4;
cada1f6 = M.f*n.f;
cada1f7dY = cada1f5dY;
cada1f7 = reshape(cada1f5,cada1f6,1);
cada1td1 = sparse(Gator1Data.Index25,Gator1Data.Index26,cada1f7dY,118,179);
cada1td1 = data.map.B*cada1td1;
cada1td1 = cada1td1(:);
cada1f8dY = full(cada1td1(Gator1Data.Index27));
cada1f8 = data.map.B*cada1f7;
cada1td1 = zeros(957,1);
cada1td1(Gator1Data.Index28) = cada1f3dY;
cada1td1(Gator1Data.Index29) = cada1td1(Gator1Data.Index29) + cada1f8dY;
cada1f9dY = cada1td1;
cada1f9 = cada1f3 + cada1f8;
cada1td1 = zeros(959,1);
...
global ADiGator_Func_Y_DuffingOscillator_Dynamics_Internal
ADiGator_Func_Y_DuffingOscillator_Dynamics_Internal = load('Func_Y_DuffingOscillator_Dynamics_Internal.mat');
return
end