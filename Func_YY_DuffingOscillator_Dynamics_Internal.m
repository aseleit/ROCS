...
function const = Func_YY_DuffingOscillator_Dynamics_Internal(X_in,U,p,t,data)
global ADiGator_Func_YY_DuffingOscillator_Dynamics_Internal
if isempty(ADiGator_Func_YY_DuffingOscillator_Dynamics_Internal); ADiGator_LoadData(); end
Gator1Data = ADiGator_Func_YY_DuffingOscillator_Dynamics_Internal.Func_YY_DuffingOscillator_Dynamics_Internal.Gator1Data;
Gator2Data = ADiGator_Func_YY_DuffingOscillator_Dynamics_Internal.Func_YY_DuffingOscillator_Dynamics_Internal.Gator2Data;
...
cada1f4 = cada1temp1;
cada1f4(:,1) = cada1f2;
cada1f5 = vdat.omega^2;
cada1f6 = uminus(cada1f5);
cada1f7dY = cada1f6*cada1f1dY;
cada1f7 = cada1f6*cada1f1;
cada2f1dY = cada1f1dY;
cada2f1 = cada1f1(:);
...
cada2f3 = 3*cada2f2;
cada1f8dYdY = cada1f1dY(:).*cada2f3dY;
cada1f8dY = cada2f3.*cada1f1dY;
cada1f8 = cada1f1.^3;
cada1f9dYdY = vdat.beta.*cada1f8dYdY;
cada1f9dY = vdat.beta*cada1f8dY;
cada1f9 = vdat.beta*cada1f8;
cada1td1 = cada1f7dY;
cada2f1dY = -cada1f9dYdY;
cada2f1 = uminus(cada1f9dY);
cada1td1dY = cada2f1dY;
cada1td1 = cada1td1 + cada2f1;
cada1f10dYdY = cada1td1dY; cada1f10dY = cada1td1;
cada1f10 = cada1f7 - cada1f9;
cada1td1 =  zeros(10062,1);
cada1td1dY = cada1f10dYdY;
cada1td1(Gator1Data.Index11) = cada1f10dY;
...
cada1td1 = sparse(Gator1Data.Index17,Gator1Data.Index18,X_vect.dY,10062,10062);
cada1td1 = data.map.A*cada1td1;
cada1td1 = cada1td1(:);
cada2f1 = cada1td1(Gator1Data.Index19);
cada1f3dY = full(cada2f1);
cada1f3 = data.map.A*X_vect.f;
cada1f4dYdY = dynF.dYdY(Gator2Data.Index1);
cada1f4dY = dynF.dY(Gator1Data.Index20);
cada1f4 = dynF.f.';
cada1tempdY = delta_t.dY(Gator1Data.Index21);
cada1tf1dY = cada1f4dY(Gator2Data.Index2);
cada1tf1 = cada1f4(Gator1Data.Index22);
cada1td1 =  zeros(35217,1);
cada2f1dY = cada1tf1dY;
cada2f1 = cada1tf1(:);
cada2tf1 = cada1tempdY(Gator2Data.Index3);
...
cada2tf1 = cada1f4dY(Gator2Data.Index5);
cada2td1 = zeros(35217,1);
cada2td1(Gator2Data.Index6) = cada2tf1(:).*cada2tempdY;
cada2td1(Gator2Data.Index7) = cada2td1(Gator2Data.Index7) + delta_t.f.*cada1f4dYdY;
cada2f2dY = cada2td1;
cada2f2 = delta_t.f*cada1f4dY;
cada2f3dY = cada2f2dY;
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(65403,1);
...
cada1td1dY = cada1f7dYdY(Gator2Data.Index11);
cada1td1 = sparse(Gator1Data.Index25,Gator1Data.Index26,cada1f7dY,10062,15095);
cada2td1 = sparse(Gator2Data.Index12,Gator2Data.Index13,cada1td1dY,10062,65403);
cada2td1 = data.map.B*cada2td1;
cada2td1 = cada2td1(:);
cada1td1dY = full(cada2td1(Gator2Data.Index14));
...
cada1td1 =  zeros(82995,1);
cada1td1(Gator1Data.Index28) = cada1f3dY;
...
cada1td1 =  zeros(82997,1);
cada1td1(Gator1Data.Index30) = cada1f2dY;
cada1td1dY = cada1f9dYdY;
cada1td1(Gator1Data.Index31) = cada1f9dY;
...
const.dY_size = [10062 15095];
const.dY_location = Gator1Data.Index32;
const.dYdY_size = [const.dY_size,15095];
const.dYdY_location = [const.dY_location(Gator2Data.Index16,:), Gator2Data.Index17];
end


function ADiGator_LoadData()
global ADiGator_Func_YY_DuffingOscillator_Dynamics_Internal
ADiGator_Func_YY_DuffingOscillator_Dynamics_Internal = load('Func_YY_DuffingOscillator_Dynamics_Internal.mat');
return
end