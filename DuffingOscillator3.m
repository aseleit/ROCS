% Duffing Oscillator Problem - x10-x1f
function [problem,guess] = DuffingOscillator3
...
% Input bounds
problem.inputs.ul=[-50];
problem.inputs.uu=[50];

% Bounds on the first control action
problem.inputs.u0l=[-50];
